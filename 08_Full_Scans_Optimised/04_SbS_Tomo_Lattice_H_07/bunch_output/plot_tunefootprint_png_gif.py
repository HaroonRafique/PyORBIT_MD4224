...
for i, file in enumerate(files[::-1]):
	...
	plt.title(r'(Q$_x$, Q$_y$) = (6.07, 6.24) turn %s'%turn, fontsize=fontsize);
	...
	plt.tight_layout();
	savename = 'tune_diagram_'+ str(turn) +'.png';
...
images = []
for filename in sorted(gifnames):
    images.append(imageio.imread(filename))
imageio.mimsave('607_624_png.gif', images, duration=(1./6.))
print 'GIF Complete'
