...
parameters['input_distn'] = str('../../01_Input_Distns/' +parameters['lattice_start'][3]+'/Tomo/'\ 
	 + str(parameters['n_macroparticles']) + '/PyORBIT_' + parameters['DistType'] + '_Bunch_'\
	 + parameters['TwissType'] + '_Twiss_Nmp_' + str(nmp) + '_' + \
	parameters['machine'] + '_' + parameters['lattice_version'] + '_Lattice_Tune_' + parameters['tunex'] + '_'\
	+ parameters['tuney'] + '_' + parameters['lattice_start'] + '.mat'
